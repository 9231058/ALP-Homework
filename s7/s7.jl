...
@constraint(m, 0.9 * (110 * x[1] + 90 * x[2] + 80 * x[3] + 50 * x[4]) + s[2] == 0.9 * (110 * y[1] + 90 * y[2] + 80 * y[3] + 50 * y[4]) + s[1])
@constraint(m, 0.81 * (1100 * x[1] + 1120 * x[2] + 1090 * x[3] + 1110 * x[4]) + s[3] == 0.81 * (1100 * y[1] + 1120 * y[2] + 1090 * y[3] + 1110 * y[4]) + s[2])
